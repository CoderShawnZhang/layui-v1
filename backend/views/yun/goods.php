...
<table class="layui-table" lay-data="{width:900, height:'full-450', url:'http://layuiv1yii.local.anlewo.com:8080/yun/json?page=1&limit=30', page:true, id:'test'}" lay-filter="test">
    <thead>
    <tr>
